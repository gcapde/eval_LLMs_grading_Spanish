...
def extract_key_word(output, cnt_mal):
    ...
    keywords = ["Calificación: SOBRESALIENTE", "Calificación: BIEN", "Calificación: DEFICIENTE", "Calificación: Sobresaliente", "Calificación: Bien", "Calificación: Deficiente"]
    lower_output = output
    ...
    try:
        ...
        for provider, prompts in model_results.items():
            for short_label, outputs in prompts.items():
                ...
                labels = ["SOBRESALIENTE", "BIEN", "DEFICIENTE"]
...
#    for archivo in ['openai_corregido_variante.json']:
    for archivo in ['openai_corregido_variante.json']:
